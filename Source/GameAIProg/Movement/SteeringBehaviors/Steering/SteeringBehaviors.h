...
public:
	...
	void SetEvadeRadius(float evadeRadius){EvadeRadius = evadeRadius;}
...
public:
	...
	void SetMaxAngleChange(float maxAngleChangeDeg) {m_MaxAngleChange = FMath::DegreesToRadians(maxAngleChangeDeg);}
